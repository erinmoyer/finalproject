---
title: "U.S. Neonicotinoid Use and Impacts on Honeybee Survival and Productivity"
author: "Erin Moyer"
date: "1/23/2019"
output: github_document
always_alow_html: yes
---
...
library(tidyverse)
library(usmap)
HoneyNeonic <- read_csv("/home/erin.moyer/Honeybee/Hunnybee/vHoneyNeonic_v03.csv")
#Loads libraries and reads in data set. 
states <- map_data("state")
#Gives me coordinate data for states in the contiguous United States.
```
